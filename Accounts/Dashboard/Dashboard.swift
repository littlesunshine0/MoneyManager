            ...
            .toolbar {
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button {
                        ...
                        LegacyIcon("arrow.clockwise", context: .toolbar)
                    }
            ...
            VStack(alignment: .leading, spacing: DesignTokens.Spacing.md) {
                ...
                HStack {
                    ...
                    if viewModel.budgetHealth != .healthy {
                        LegacyIcon(viewModel.budgetHealth.iconName, context: .inline, color: viewModel.budgetHealth.color)
...
private struct QuickActionButton: View {
    ...
    var body: some View {
        Button(action: action) {
            LegacyIcon(icon, context: .inline, color: color)
    ...
    var body: some View {
        FinancialCard(shadowLevel: .light) {
            VStack(alignment: .leading, spacing: DesignTokens.Spacing.sm) {
                HStack {
                    LegacyIcon(account.accountType.iconName, context: .inline, color: Color(hex: account.color))
        ...
        VStack(alignment: .leading, spacing: DesignTokens.Spacing.md) {
            HStack {
                ...
                HStack(spacing: DesignTokens.Spacing.xs) {
                    LegacyIcon(health.iconName, context: .status, color: health.color)
...
private struct GoalCard: View {
    ...
    var body: some View {
        FinancialCard(shadowLevel: .light) {
            VStack(alignment: .leading, spacing: DesignTokens.Spacing.sm) {
                HStack {
                    LegacyIcon(goal.iconName, context: .inline, color: Color(hex: goal.color))
...
private struct RecentTransactionsSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: DesignTokens.Spacing.md) {
            ...
            FinancialCard(shadowLevel: .light) {
                VStack(spacing: 0) {
                    ForEach(Array(transactions.prefix(5).enumerated()), id: \.1.id) { index, transaction in
